        ...
        >
          {trustItems.map((item, i) => {
            ...
            return (
              ...
              >
                {/* glowing icon */}
                <div className={`w-24 h-24 mx-auto mb-8 rounded-full bg-gradient-to-br ${item.gradient} flex items-center justify-center group-hover:scale-110 transition-transform duration-500`}>
